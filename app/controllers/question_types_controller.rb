  ...
  def create
    ...
    respond_to do |format|
      if @question_type.save
        format.html { redirect_to question_type_url(@question_type), notice: "Question type was successfully created." }
  ...
  def update
    respond_to do |format|
      if @question_type.update(question_type_params)
        format.html { redirect_to question_type_url(@question_type), notice: "Question type was successfully updated." }
